...
const planColor: Record<string, string> = { free: 'gray', basic: 'blue', pro: 'primary', elite: 'primary' }
      ...
      <div className="flex items-center justify-between px-4 md:px-6 h-14">
        ...
        <Link href="/dashboard" className="flex items-center gap-2.5 select-none">
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(23,185,120,0.2) 0%, rgba(23,185,120,0.08) 100%)',
          ...
          <span className="font-semibold text-[15px] tracking-tight hidden sm:block" style={{ color: 'var(--text-1)' }}>
            Finvest<span style={{ color: 'var(--primary)' }}>Pro</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          {plan !== 'elite' && (
            <Link
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(23,185,120,0.15), rgba(23,185,120,0.08))',
                border: '1px solid var(--border-primary)',
          ...
          >
            {photo ? (
              ...
              <div
                ...
                style={{ background: 'var(--primary-dim)', border: '1px solid var(--border-primary)', color: 'var(--primary)' }}
              >
